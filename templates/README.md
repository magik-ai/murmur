...
Fill-in files. Replace every `<PLACEHOLDER>`.

| File | Purpose | Source it is generalized from |
|---|---|---|
| CLAUDE.md | repo law: boot contract, workflow gates, hard rules | the product repo's CLAUDE.md |
| personal-CLAUDE.md | the operator's own law: coordination, farm, style | ~/.claude/CLAUDE.md |
| AGENTS.md | product briefing shape | the product repo's AGENTS.md |
| PULL_REQUEST_TEMPLATE.md | summary, slice, acceptance guide, checklist | .github/PULL_REQUEST_TEMPLATE.md |
| GOTCHAS.md | lessons file, symptom -> cause -> prevention | docs/GOTCHAS.md header |
