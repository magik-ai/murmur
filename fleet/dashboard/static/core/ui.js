...
/* The vendors' own marks, the ones the first farm page drew on its cards: Anthropic's Claude
   burst in its own orange, OpenAI's knot in the text colour so it holds in both themes. An
   engine without a mark here is said in words by the caller. */
const ENGINE_MARKS = {
