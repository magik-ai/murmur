...
g(work,"worktree","add","-q","-b","brain-prune",wt)
...
saved, detail = S.salvage(wt, "brain-prune-145224")
check("salvage reports saved", saved and "brain-prune-145224" in detail)
refs = g(work,"ls-remote","origin","refs/fleet-salvage/*").stdout
check("salvage ref exists on origin with the lane commit",
      "refs/fleet-salvage/brain-prune-145224" in refs and lane_sha in refs)
...
g(wt,"push","-q","origin","HEAD:refs/heads/brain-prune")
saved2, detail2 = S.salvage(wt, "brain-prune-again")
...
#    land brain-prune into main
g(work,"fetch","-q","origin"); g(work,"merge","-q","origin/brain-prune"); g(work,"push","-q","origin","main")
...
check("cleanup drops the landed salvage ref",
      "refs/fleet-salvage/brain-prune-145224" in dropped)
...
check("graveyard stays clean: only the orphan salvage ref remains",
      "orphan-lane" in remaining and "brain-prune-145224" not in remaining)
