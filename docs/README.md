...
New to all of this? [Getting started from zero](getting-started.md) goes from a new Mac, Windows PC or Linux PC to your first team of agents, one command at a time.
